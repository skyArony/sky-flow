...
6. Fan-in and verify：主代理读取子代理结果，检查 changed files、task 要求、spec alignment、artifact 更新和验证结果；必要时触发 test / review / consolidation / acceptance / validate-flow。
...
9. Acceptance gate：到达人类验收、sign-off、争议确认或反馈节点时，调用 `to-acceptance` 创建或更新验收文档。
