---
name: to-knowledge
description: 'Capture concise, source-backed, project-agnostic developer knowledge notes for infrastructure, foundational components, libraries, tooling, architecture patterns, troubleshooting lessons, and technology option comparisons. Use automatically when Codex discovers durable technical facts, caveats, setup procedures, package capabilities, ecosystem tradeoffs, or long-document summaries that are broadly reusable and not tied to a specific business, project, customer, incident, or implementation plan.'
---
...
- 项目业务事实、客户需求、线上事故细节、内部部署拓扑、账号、密钥、内网地址或公司专有流程。
